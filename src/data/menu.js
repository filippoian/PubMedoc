export const menuCategories = [
    {
        ...
        items: [
            ...
            { name: 'CHAIN BREAKER', price: '€7', description: '6,1% VOL, 40 IBU, Lattina 44 CL - INDIA PALE ALE, IMPAVIDA, GLUTENFREE' },
            { name: 'MOXIE', price: '€7', description: '5,5% VOL, 30 IBU, Lattina 44 CL - AMERICAN PALE ALE, IMPAVIDA' },
            ...
            { name: 'MARGOSE', price: '€7', description: '4,6% VOL, Bottiglia 33 CL - Gose con acqua di mare, Birranova, Puglia, Italia' },
            { name: 'TROPICAL BOMB', price: '€7', description: '8% VOL, Lattina 33 CL - DOUBLE IPA, REBEL\'S BREWERY, ROMA, ITALIA' },
            { name: 'LIL TROPICAL', price: '€7', description: '4,5% VOL, Lattina 33 CL - SESSION IPA, REBEL\'S BREWERY, ROMA, ITALIA' },
        ]
    },
    {
        id: 'stuzzicheria',
